...
public class MyAppRunner implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		 ...
		 * 
		 * CourseEntity cEntity1=new CourseEntity(2001, "Java", null); CourseEntity
		 * cEntity2=new CourseEntity(2002, "Python", null); CourseEntity cEntity3=new
		 * CourseEntity(2003, "Data ETL", null); CourseEntity cEntity4=new
		 * CourseEntity(2004, "MYSQL", null); CourseEntity cEntity5=new
		 * CourseEntity(2005, "DOT NET", null);
		 * 
		 * List<CourseEntity> collection1=new ArrayList<>(); collection1.add(cEntity1);
		 * collection1.add(cEntity2); collection1.add(cEntity3);
		 * sEntity1.setCourseList(collection1);
		 * 
		 * List<CourseEntity> collection2=new ArrayList<>(); collection2.add(cEntity3);
		 * collection2.add(cEntity4); collection2.add(cEntity5);
		 * sEntity2.setCourseList(collection2);
		 * 
		 * List<CourseEntity> collection3=new ArrayList<>(); collection3.add(cEntity5);
		 * collection3.add(cEntity2); collection3.add(cEntity1);
		 * sEntity3.setCourseList(collection3);
		 * 
		 * studentRepo.save(sEntity1); studentRepo.save(sEntity2);
		 * studentRepo.save(sEntity3);
		 */

		CourseEntity new_course = new CourseEntity(2006, "Scala");
		StudentEntity sEntity = studentRepo.findById(1001).get();
